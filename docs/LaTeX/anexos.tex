...
\definecolor{mucolor}{rgb}{.89,0.44,0.48}
...
\begin{mdframed}[outerlinecolor=black,outerlinewidth=2pt,linecolor=cccolor,middlelinewidth=3pt,roundcorner=10pt,nobreak=true]
  This work is licensed under a \href{https://creativecommons.org/licenses/by/4.0/deed.es}{Creative Commons Attribution 4.0 International License}.
  \begin{center}
