...
\imagen{ejemploMetadatos}{Ejemplo de metadatos.}{0.65}
...
\imagen{diagramacampos}{Estructura básica de un esquema de metadatos.}{0.9}
...
\imagen{mapping}{Ejemplo de mapeo entre el esquema ``Dublin Core'' y el modelo ``AO-Cat''.}{0.9}
...
\imagen{enrichmentconcept}{Proceso de enriquecimiento de datos.}{0.7}

\subsection{\emph{D4Science}}

\emph{D4Science} \cite{weboff:dfour}
...
La aplicación \emph{software} escogida (\emph{Omeka Classic} \cite{weboff:omeka}) emplea
...
\imagen{oai-pmh}{Ejemplo básico del protocolo \emph{OAI-PMH}.}{0.6}
