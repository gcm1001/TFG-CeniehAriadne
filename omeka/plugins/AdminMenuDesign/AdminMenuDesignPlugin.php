<?php
/**
 * PLUGIN AdminMenuDesign
 *
 * @license https://www.gnu.org/licenses/gpl-3.0.html
 * @package AdminMenuDesign
 */
class AdminMenuDesignPlugin extends Omeka_Plugin_AbstractPlugin {
    ...
    private function _sections(){
        if(empty($this->_sections)){
            require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'sections.php';
