<div id="div-phase-4">
    ...
    <h1 class="h1-phase" >It's almost done!<span class="span-form">Please, follow these steps.</span></h1>
                ...
                <div id="help-button-popup" class="help-popup">
                    <div  class = "frame">
                       ...
                       <div id="default-message" class = "message">
                            <form id="msg-form" action="<?= html_escape(url('ariadne-plus-tracking/index/mail')); ?>" method='post'>
        ...
        <div class="section"><span class="span-form-step">3</span>If everything is fine, set the SPARQL endpoint.</div>
        <div class="inner-wrap">
            <p>You should see a SPARQL endpoint in the received message. Paste it here.</p>
            <form id="form-phase-4" action="#" method='post'>
            <label>SPARQL endpoint <input id="sparql"  type="text" name="sparql" value="<?= html_escape(metadata($record, array('Monitor', 'Ghost SPARQL'))) ?>"/></label>
            </form>
        </div>
    </div>
</div>
