...
<div id="primary">
    ...
    <div class="renew">
        <a id="renew-btn" href="#" class="renew-btn btn-2">
    ...
    <div class="next">
        <a id="next-btn" href="<?= html_escape(url('ariadne-plus-tracking/index/stage', array('url' => WEB_ROOT,'record_type' => get_class($record), 'element' => $elementId, 
...
<p><?= __('Go back to %sARIADNEplus Tracking%s.', '<a href="' . 
                html_escape(url('ariadne-plus-tracking')) . '">', '</a>'); ?></p>
<?php endif; ?>
