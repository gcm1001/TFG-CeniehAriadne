<?php
   ...
   */
    ...
    include_once(dirname(dirname(dirname(dirname(__FILE__)))).'/helpers/CENIEHExporter.php'); // se importa la clase CirEXporte
    ...
    if(!isset($collectionID)) return 'ERROR: collection ID not set'; // se comprueba que existe la colección
      ...
      try{ ?><?= $CENIEHExporter->exportCollectionMeta($collectionID); ?>
