 ...
 * 
 * @package CollectionFiles\File\Ingest
 */
class CollectionFiles_File_Ingest_Filesystem extends CollectionFiles_File_Ingest_AbstractSourceIngest
{
    /**
    ...
    protected function _transfer($source, $destination, array $info)
    {
        ...
        if (!$result) {
            throw new CollectionFiles_File_Ingest_Exception("Could not transfer \"$source\" to \"$destination\".");
        }
    }
