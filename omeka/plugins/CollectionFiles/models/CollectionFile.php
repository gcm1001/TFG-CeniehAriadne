 ...
 * 
 */
class CollectionFile extends Omeka_Record_AbstractRecord implements Zend_Acl_Resource_Interface
{
    /**
    ...
    /**
     * Relative order of this File within the parent collection.
     *
     * @var int
     */
    public $order;
    ...
    public function getProperty($property)
    {
        switch ($property) {
            ...
            case 'permalink':
                return absolute_url(array('controller' => 'collection-files', 'action' => 'show', 'id' => $this->id));
            case 'display_title':
    ...
    protected function filterPostData($post)
    {
        $immutable = array('id', 'modified', 'added', 'authentication', 'filename',
                           'original_filename', 'mime_type', 'type_os', 'collection_id');
    ...
    protected function afterSave($args)
    {
        if ($args['insert']) {
            ...
            $dispatcher->send('Job_CollectionFileProcessUpload', array('fileData' => $this->toArray()));
        }
    ...
    /**
     * Get the collection this file belongs to.
     * 
     * @return collection
     */
    public function getcollection()
    {
        return $this->getTable('Collection')->find($this->collection_id);
    }
     ...
     *
     * Proxies to the collection's isOwnedBy.
     *
